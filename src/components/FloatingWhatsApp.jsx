    ...
    return (
        <>
            ...
            <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="hidden md:flex fixed bottom-24 right-8 z-40 items-center justify-center w-16 h-16 bg-gradient-to-r from-green-500 to-green-600 rounded-full shadow-premium hover:shadow-lg transition-all duration-300 text-white text-3xl"
            >
                <FaWhatsapp />
            </motion.a>
